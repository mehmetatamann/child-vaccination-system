...
<head>
    <meta charset="utf-8">
    <title>ÇAVİS - Reddedilen Hastaneler</title>
        ...
        <div class="row">
            ...
            <div class="col-md-10">
                ...
                if (mysqli_num_rows($hastane_sorgu_sonuc) < 1) {
                    echo "
                    <tr>
                        <td colspan='5' class='text-center'>Reddedilen hastane başvurusu bulunamadı.</td>
                    </tr>";
                } else {
